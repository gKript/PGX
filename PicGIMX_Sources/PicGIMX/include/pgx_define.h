//
#ifndef _PGIMX_DEFINE_H_
	#define _PGIMX_DEFINE_H_
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	#define	PGX_ON							1								/*!	An alternative way to say "logic value 1"	*/
	#define	PGX_OFF							0								/*!	An alternative way to say "logic value 0"	*/
	//------------------------------------------------------------------------
	#define	PGX_IN							1								/*!	To program a PIN in INPUT	*/
	...
	//------------------------------------------------------------------------
	#define	PGX_INCLUDE						1								/*!	An alternative way to say "logic value 1"	*/
	#define	PGX_NOT_INCLUDE					0								/*!	An alternative way to say "logic value 0"	*/
	//------------------------------------------------------------------------
	...
	#define PGX_REVERSE						1								/*!	An alternative way to say "logic value 1"	*/
	//------------------------------------------------------------------------
	...
	#define	PGX_MHZ							6								/*!	A frequency unit : Megahertz	*/
	//------------------------------------------------------------------------
	...
	#define PGX_AUTOMATIC					2								/*!	A Serial module mode : Automatic	*/
	//------------------------------------------------------------------------
//	#define	PGX_PWM_1_MODE													//defined in pgim_<mcu>.h
//	#define	PGX_PWM_2_MODE													//defined in pgim_<mcu>.h
	//------------------------------------------------------------------------
...
//	#define PWM_MODE_4														//defined in ../plib/pwm.h
	//------------------------------------------------------------------------
	#define	PGX_DEBUG_LCD_CHAR				1								/*!	To use the LCD CHAR as debug output */
//	#define PGX_DEBUG_LCD_PCD8544			2
	...
	#define	PGX_LINE_2						2								/*!	This is the line 2 */
	#define	PGX_LINE_3						3								/*!	This is the line 3 */
	//------------------------------------------------------------------------
	#define	PGX_SENSOR_METHOD_BETA			1								/*!	Beta calculation method for ntc sensors */
	#define	PGX_SENSOR_METHOD_COEF			2								/*!	Coefficients calculation method for ntc sensors */
	//------------------------------------------------------------------------
	#define	PGX_DEGREES_CELSIUS				1								/*!	Indicates the use of Celsius scale */		//(generic define, not dedicated to the sensor module)
	#define	PGX_DEGREES_FAHRENHEIT			2								/*!	Indicates the use of Fahrenheit scale */	//(generic define, not dedicated to the sensor module)
	//------------------------------------------------------------------------
	#define	PGX_LSB_FIRST					0								/*! It indicates whether the byte is read or written starting from the least significant bit LSB */
	#define	PGX_MSB_FIRST					1								/*! It indicates whether the byte is read or written starting from the most significant bit MSB */
	//------------------------------------------------------------------------
	#define	PGX_PARALLEL_MODE				0								/*! It indicates whether the item is parallel */
	#define	PGX_SERIAL_MODE					1								/*! It indicates whether the item is serial */
	//------------------------------------------------------------------------
	//	M A T H E M A T I C A L   C O N S T A N T S   D E F I N E S
	//------------------------------------------------------------------------
	#define	PGX_CONST_PI                     3.1415926535897					//!< Pi-Greek
	#define	PGX_CONST_E                      2.7182818284590					//!< Euler's number. Base of the natural logarithm
	//------------------------------------------------------------------------
	//	P H Y S I C A L   C O N S T A N T S   D E F I N E S
	//------------------------------------------------------------------------
	#define	PGX_CONST_C						299792458						//!< Speed of light. Unit of measure: [m/s]
	#define	PGX_CONST_BOLTZMANN				1.3806488E-23					//!< Boltzmann's constant. Unit of measure: [J/K]
	#define	PGX_CONST_PLANK_JS				6.62606957E-34					//!< Planck's constant. Unit of measure: [J*s]
	#define	PGX_CONST_PLANK_EV				4.13562852E-15					//!< Planck's constant. Unit of measure: [eV*s]
	#define	PGX_CONST_ELEMENTARY_CHARGE		1.602176565E-19 				//!< Elementary charge. Unit of measure: [C]
	#define	PGX_CONST_GRAVITY_ACCEL			9.80665							//!< Gravitational acceleration. Unit of measure: [m/(s^2)]
	#define	PGX_CONST_KELVIN_CONST			-273.15							//!< Absolute value of the absolute zero temperature (0�K) in degrees Celsius
	//------------------------------------------------------------------------
	//	C H E M I S T R Y   C O N S T A N T S   D E F I N E S
	//------------------------------------------------------------------------
	#define	PGX_CONST_AVOGADRO               6.02214129E+23					//!< Avogadro's number
	//------------------------------------------------------------------------
	//	P I N   D E F I N E S
	//------------------------------------------------------------------------
	/*!
	 ...
	 * \return			Nothing.
	 */
	#define	pgx_pin_mode( pin , mode )			pin = mode
	//------------------------------------------------------------------------
	/*!
	 ...
	 * \return			Nothing.
	 */
	#define	pgx_pin_set( pin )					pin = PGX_SET
	//------------------------------------------------------------------------
	/*!
	 ...
	 * \return			Nothing.
	 */
	#define	pgx_pin_clear( pin )				pin = PGX_CLEAR
	//------------------------------------------------------------------------
	/*!
	 ...
	 * \return			Nothing.
	 */
	#define	pgx_pin_toggle( pin )			( pin ^= 1 )
	//------------------------------------------------------------------------
...
/*!
	\page	PGX_consideraproj		Planning a new project with PicGIM
		\tableofcontents
