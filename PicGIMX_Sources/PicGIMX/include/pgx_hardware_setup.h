//
	...
	//========================================================================
		...
		#warning PGX: This is the first time you have compiled your project with PGX. First of all you have to set the correct power supply value in "pgx_hardware_setup_public.h".
	...
	//------------------------------------------------------------------------
		...
		#warning PGX: MCU power supply is greater than its maximum specification.
		#ifndef PGX_EXIT_ON_ERROR
			#define PGX_EXIT_ON_ERROR
		#endif
	#elseif( PGX_USER_SUPPLY_MILLIVOLT < PGX_MCU_SUPPLY_VOLT_MIN )
		#warning PGX: MCU power supply is lower than the correct specification.
		#ifndef PGX_EXIT_ON_ERROR
			#define PGX_EXIT_ON_ERROR
		#endif
    #endif
	...
	//========================================================================
	#if ( PGX_CLOCK_HZ == 0 )
		#warning PGX: This is the first time you have compiled your project with PGX. First of all you have to set the correct frequency oscillator value in "pgx_hardware_setup_public.h".
		#ifndef PGX_EXIT_ON_ERROR
			#define PGX_EXIT_ON_ERROR
		#endif
	#endif
	//------------------------------------------------------------------------
		...
		#error PGX: Frequency clock too high!
		#ifndef PGX_EXIT_ON_ERROR
			#define PGX_EXIT_ON_ERROR
		#endif
	#endif
